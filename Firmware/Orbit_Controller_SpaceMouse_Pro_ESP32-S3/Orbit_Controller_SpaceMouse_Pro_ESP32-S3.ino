...
const int VID[NUM_DEVICES] = {0x256F, 0x046D};
const int PID[NUM_DEVICES] = {0xC635, 0xC62B};
...
const int buttonPins[BUTTON_COUNT] = { 
  ...
  NC, NC, NC, NC, NC, NC, 38, 39,   // 16-23 bit = |   -    |  -   |  -   | - | - | - | ESC | ALT |
  40, 41, 42, NC, NC, NC, NC, NC    // 24-31 bit = | SHIFT  | CTRL | LOCK | - | - | - |  -  |  -  |
}; // GPIOs
...
// Set the VID and PID for USB
void setDevice(DEVICE_TYPE deviceType) {
  TinyUSBDevice.setID( VID[deviceType], PID[deviceType] );
...
void setup() {
  ...
  // Change this line to emulate another device
  setDevice(SPACEMOUSE_PRO);
